...
QickArray* Convert_QickArray:: py2my_copy(PyObject* a_)
{
  ...
  */
  ...
  if (a->nd == 1) {
    ma->redim((int) a->dimensions[0]);
  } else if (a->nd == 2) {
    ma->redim((int) a->dimensions[0], (int) a->dimensions[1]);
  } else if (a->nd == 3) {
    ma->redim((int) a->dimensions[0], (int) a->dimensions[1], (int) a->dimensions[2]);
  } else if (a->nd == 4) {
    ma->redim((int) a->dimensions[0], (int) a->dimensions[1], (int) a->dimensions[2],
	      (int) a->dimensions[3]);
  } else if (a->nd == 5) {
    ma->redim((int) a->dimensions[0], (int) a->dimensions[1], (int) a->dimensions[2],
	      (int) a->dimensions[3], (int) a->dimensions[4]);
  } else if (a->nd == 6) {
    ma->redim((int) a->dimensions[0], (int) a->dimensions[1], (int) a->dimensions[2],
	      (int) a->dimensions[3], (int) a->dimensions[4], (int) a->dimensions[5]);
  }
  // copy data:
